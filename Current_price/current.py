...
params = {
    ...
    'limit': 100,      # Maximum number of data
    'aggregate': 1,     # Interval 1min
    'api_key': '6bd78243689fbb635cd376fd6247d7e380465eef7e0fa753e8c02e341f6e579a'
}
...
with open('current.csv', mode='w', newline='') as csv_file:
...
print('Bitcoin historical closing prices saved to current.csv')